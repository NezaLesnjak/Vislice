...
@bottle.get('/')
def index():
    return bottle.template('Vislice/datoteke/index.tpl')
...
@bottle.get('/igra/')
def pokazi_igro():
    id_igre = int(bottle.reqest.get_cookie(ID_IGRE_COOKIE_NAME, secret=COOKIE_SECRET))
    igra, poskus = vislice.igre[id_igre]

    return bottle.template('./Vislice/datoteke/igra.tpl', igra=igra, poskus=poskus, id_igre=id_igre)
